  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div id="newsfeed-items-grid">
        ...
        <div class="ui-block">
          <article class="hentry post video">
            ...
            <div class="post__author author vcard inline-items">
              ...
              <div class="author-date">
                <a class="h6 post__author-name fn" href="#">Marina
                  Valentine</a> shared a <a href="#">link</a>
            ...
            <p>
              ...
              this new song by Iron Maid. The next time they come to the
              city we should totally go!
            </p>

            <div class="post-video">
              <div class="video-thumb">
                <img
                  src="<%=application.getContextPath()%>/resources/img/video-youtube1.jpg"
                  alt="photo"> <a
                  href="https://youtube.com/watch?v=excVFQ2TWig"
                  class="play-video"> <svg class="olymp-play-icon">
                    <use
                      xlink:href="<%=application.getContextPath()%>/resources/icons/icons.svg#olymp-play-icon"></use></svg>
                </a>
              </div>
            ...
            <div class="post-additional-info inline-items">
              ...
              <a href="#" class="post-add-icon inline-items"> <svg
                  ...
                  <use
                    xlink:href="<%=application.getContextPath()%>/resources/icons/icons.svg#olymp-heart-icon"></use></svg>
                <span>18</span>
              </a>

              <ul class="friends-harmonic">
                <li><a href="#"> <img
                    src="<%=application.getContextPath()%>/resources/img/friend-harmonic9.jpg"
                    alt="friend">
                </a></li>
                <li><a href="#"> <img
                    src="<%=application.getContextPath()%>/resources/img/friend-harmonic10.jpg"
                    alt="friend">
                </a></li>
                <li><a href="#"> <img
                    src="<%=application.getContextPath()%>/resources/img/friend-harmonic7.jpg"
                    alt="friend">
                </a></li>
                <li><a href="#"> <img
                    src="<%=application.getContextPath()%>/resources/img/friend-harmonic8.jpg"
                    alt="friend">
                </a></li>
                <li><a href="#"> <img
                    src="<%=application.getContextPath()%>/resources/img/friend-harmonic11.jpg"
                    alt="friend">
                </a></li>
              </ul>

              <div class="names-people-likes">
                <a href="#">Jenny</a>, <a href="#">Robert</a> and <br>18
                more liked this
              </div>
        ...
        <div class="ui-block">
          <article class="hentry post">
            ...
            <div class="post__author author vcard inline-items">
              ...
              <div class="author-date">
                <a class="h6 post__author-name fn" href="#">Elaine
                  Dreyfuss</a>
                <div class="post__date">
                  <time class="published" datetime="2004-07-24T18:18">
                    9 hours ago </time>
            ...
            <div class="post-additional-info inline-items">
              ...
              <div class="names-people-likes">
                <a href="#">You</a>, <a href="#">Elaine</a> and <br>22
                more liked this
              </div>
            ...
            <li>
              <div class="post__author author vcard inline-items">
                ...
                <a href="#" class="more"><svg
                    ...
                    <use
                      xlink:href="<%=application.getContextPath()%>/resources/icons/icons.svg#olymp-three-dots-icon"></use></svg></a>

              </div>

              <p>Sed ut perspiciatis unde omnis iste natus error sit
                voluptatem accusantium der doloremque laudantium.</p> <a
              href="#" class="post-add-icon inline-items"> <svg
                  class="olymp-heart-icon">
                  <use
                    xlink:href="<%=application.getContextPath()%>/resources/icons/icons.svg#olymp-heart-icon"></use></svg>
                <span>3</span>
        ...
        <div class="ui-block">
          <article class="hentry post has-post-thumbnail">
            ...
            <div class="post__author author vcard inline-items">
              <img
                src="<%=application.getContextPath()%>/resources/img/avatar3-sm.jpg"
                alt="author">

              <div class="author-date">
                <a class="h6 post__author-name fn" href="#">Sarah
                  Hetfield</a>
                <div class="post__date">
                  <time class="published" datetime="2004-07-24T18:18">
                    March 2 at 9:06am </time>
                </div>
              </div>
      ...
      <a id="load-more-button" href="#" class="btn btn-control btn-more" data-load-link="items-to-load.html" data-container="newsfeed-items-grid">
        <svg class="olymp-three-dots-icon">
          <use xlink:href="<%=application.getContextPath()%>/resources/icons/icons.svg#olymp-three-dots-icon">
          </use>
        </svg>
      </a>
      ...
      <!-- Left Sidebar -->
      <aside
        class="col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-12 col-xs-12">
        <%-- 내 정보 위젯 --%>
